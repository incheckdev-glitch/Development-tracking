...
function bindGlobalActions(){
  ...
  document.addEventListener("click", event => {
    ...
    if(finding){
      openDrilldown("Urgent Finding", detailCards([["Finding", finding.querySelector("b")?.textContent || "-"],["Status", finding.querySelector(".status")?.textContent || "Open"],["Priority", "Urgent"],["Action", "Correct and repeat audit"]]));
      return;
    }
